...
const TypingIndicator: React.FC = () => {
  return (
    <div className="flex items-start gap-3 my-2">
      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-emerald-900 text-white">
      ...
      <div className="chat-bubble-ai flex items-center gap-2 py-3 px-4 shadow-xs">
        ...
        <span className="text-xs text-slate-500 font-medium">AI Mentor is thinking...</span>
      </div>
    </div>
  );
};
